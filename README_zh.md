...
<h3>用你记住的概念，找回读过的论文。</h3>

<p>以标签组织论文，以大模型辅助理解。轻量收藏，简洁管理。</p>
...
读完一篇论文，过一段时间，我们可能已经记不清它的完整标题，留在脑海中的却往往是几个关键词、一些概念，或者一个印象深刻的方法。比如“检索增强生成”“智能体”“证据验证”——这些零散的线索，共同构成了我们对这篇论文的整体印象，也常常是下一次想起它的起点。
...
你决定用哪些标签描述论文，大模型则根据你给出的标签和关联论文的内容，补充标签的含义与适用范围，辅助检索和发现相关论文。通过复用已有标签、控制新增数量，让分类保持清晰。**轻量、简洁，让整理顺手发生，让查找从一个概念开始。** 论文库保存在本机，基础收藏与查找无需配置模型。
